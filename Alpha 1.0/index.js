...
const URL =
  'https://docs.google.com/forms/d/e/1FAIpQLSdo727ovL-zbVIZZWr7_c5eyI-ubWc7br7441yjsrkjfkww9Q/viewform';
...
async function init() {
  ...
  await Sele.fillShortAnswer('ELTE');
  ...
  await Sele.fillGrid(
    ...
    3,
    4,
    [1, ...getRandomIntArray(getRandomInt(4), 4)],
    [2, ...getRandomIntArray(getRandomInt(4), 4)],
    [3, ...getRandomIntArray(getRandomInt(4), 4)]
  );
  await Sele.fillGrid(
    'choice',
    2,
  ...
  await Sele.fillGrid(
    ...
    3,
    2,
    [1, ...getRandomIntArray(getRandomInt(2), 2)],
    [2, ...getRandomIntArray(getRandomInt(2), 2)],
    [3, ...getRandomIntArray(getRandomInt(2), 2)]
  );
